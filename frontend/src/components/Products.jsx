  ...
  const fetchProducts = useCallback(async () => {
    ...
    try {
      ...
      if (isMounted.current) {
        ...
        // Fallback data
        const fallbackData = [
          { PRODUCT_ID: '1', NAME_EN: 'Laptop Pro', NAME_KH: 'កុំព្យូទ័រយួរដៃ', BARCODE: 'LP001', BRAND: 'TechPro', SALEOUT_PRICE: 1299.99, QtyInStock: 50, QTY_ALERT: 10, STATUS: 'Active' },
          { PRODUCT_ID: '2', NAME_EN: 'Smartphone X', NAME_KH: 'ទូរស័ព្ទឆ្លាត', BARCODE: 'SP002', BRAND: 'PhoneMaster', SALEOUT_PRICE: 899.99, QtyInStock: 30, QTY_ALERT: 10, STATUS: 'Active' },
          { PRODUCT_ID: '3', NAME_EN: 'Wireless Mouse', NAME_KH: 'កណ្ដុរឥតខ្សែ', BARCODE: 'WM003', BRAND: 'Accessory', SALEOUT_PRICE: 29.99, QtyInStock: 100, QTY_ALERT: 15, STATUS: 'Active' },
          { PRODUCT_ID: '4', NAME_EN: 'Keyboard Pro', NAME_KH: 'ក្ដារចុច', BARCODE: 'KP004', BRAND: 'Accessory', SALEOUT_PRICE: 79.99, QtyInStock: 45, QTY_ALERT: 10, STATUS: 'Active' },
          { PRODUCT_ID: '5', NAME_EN: 'USB-C Hub', NAME_KH: 'Hub USB-C', BARCODE: 'UH005', BRAND: 'TechPro', SALEOUT_PRICE: 49.99, QtyInStock: 5, QTY_ALERT: 10, STATUS: 'Active' },
        ];
      ...
      <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500 rounded-2xl p-6 text-white shadow-xl">
        <div className="flex flex-wrap justify-between items-center">
          <div>
            ...
            <p className="text-indigo-100 mt-1 text-sm">Manage your product catalog and inventory</p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {filteredProducts.map((product, index) => {
            ...
            return (
              <div
                key={id}
                className={`bg-white dark:bg-gray-800 rounded-2xl shadow-sm border-2 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 group animate-fadeIn ${
              ...
              >
                <div className="p-5">
                  ...
                  <div className="flex justify-between items-start mb-3">
                    <div className="flex items-center gap-2">
                      <div className="p-2 rounded-xl bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20">
                  ...
                  <div className="flex flex-wrap gap-2 mb-3">
                    <span className="text-[10px] bg-gray-100 dark:bg-gray-700 px-2 py-0.5 rounded-full text-gray-500 dark:text-gray-400 font-mono">
                      {barcode}
                    </span>
                    {brand && (
                      <span className="text-[10px] bg-purple-100 dark:bg-purple-900/30 px-2 py-0.5 rounded-full text-purple-600 dark:text-purple-400">
                        {brand}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2 pt-3 border-t border-gray-100 dark:border-gray-700">
                    <div className="flex items-center gap-2">
                      <span className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium ${stockBadge.color}`}>
                ...
                {filteredProducts.map((product, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-3 py-3 text-sm text-right font-medium dark:text-white">
                        {formatPrice(salePrice)}
                      </td>
