        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {filteredStock.map((item, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`p-5 rounded-t-2xl bg-gradient-to-r ${status.gradient}`}
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      <div className="p-2 rounded-xl bg-white/50 dark:bg-gray-700/50">
                        <Package className="w-5 h-5 text-indigo-600 dark:text-indigo-400" />
                      </div>
                      <div>
                        <h3 className="font-semibold text-gray-800 dark:text-white text-sm truncate max-w-[130px]">
                          {productName}
                        </h3>
                        {productNameKh && (
            ...
            <table className="w-full">
              <thead className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50">
                <tr>
                  ...
                  <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider hidden sm:table-cell">
                    Reserved
                  </th>
                  <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                    Available
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                {filteredStock.map((item, index) => {
                  ...
                  return (
                    <tr
                      key={productId || index}
                      className={`hover:bg-gray-50 dark:hover:bg-gray-700/30 transition group animate-slideIn ${
                        status.priority === 3
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6 p-4 bg-gray-50 dark:bg-gray-700/30 rounded-xl">
                ...
                <div>
                  ...
                  <p className="font-medium dark:text-white">
                    {selectedProduct.PRODUCT_ID || selectedProduct.product_id}
                  </p>
                </div>
                <div>
                  <p className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="p-3 bg-gray-50 dark:bg-gray-700/30 rounded-xl">
                  ...
                  <p className="text-lg font-bold dark:text-white">
                    {getStockValue(selectedProduct, "QtyInStock")}
                  </p>
                </div>
                <div className="p-3 bg-gray-50 dark:bg-gray-700/30 rounded-xl">
                  <p className="text-xs text-gray-400">Reserved</p>
                  <p className="text-lg font-bold dark:text-white">
                    {getStockValue(selectedProduct, "QtyReserved")}
                  </p>
                </div>
                <div className="p-3 bg-gray-50 dark:bg-gray-700/30 rounded-xl">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="p-3 bg-gray-50 dark:bg-gray-700/30 rounded-xl">
                  ...
                  <p className="text-lg font-bold dark:text-white">
                    {formatPrice(getStockValue(selectedProduct, "BUYIN_PRICE"))}
                  </p>
                </div>
                <div className="p-3 bg-gray-50 dark:bg-gray-700/30 rounded-xl">
                  <p className="text-xs text-gray-400">Sale Price</p>
                  <p className="text-lg font-bold text-indigo-600 dark:text-indigo-400">
                    {formatPrice(
                      getStockValue(selectedProduct, "SALEOUT_PRICE"),
                    )}
                  </p>
                </div>
              </div>
